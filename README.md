...
Current settings are saved upon closing application but also can be saved as presets (up to 10) and loaded so they can be switched easily and accessed when needed.
